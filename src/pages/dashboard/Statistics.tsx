...
const Statistics: React.FC = () => {
    ...
    const formatDate = (dateStr: string) => {
        ...
        if (days === 0) return `Bugün, ${date.toLocaleTimeString('tr-TR', { hour: '2-digit', minute: '2-digit' })}`;
    ...
    return (
        <div>
                ...
                <Card className="bg-red-500/10 border border-red-500/20">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-red-400">{tebligatStats.unread}</p>
                        </div>
                ...
                <Card className="bg-yellow-500/10 border border-yellow-500/20">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-yellow-400">{tebligatStats.read}</p>
                        </div>
                ...
                <Card className="bg-emerald-500/10 border border-emerald-500/20">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-emerald-400">{tebligatStats.processed}</p>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card>
                    ...
                    <div className="space-y-3">
                        {recentTebligatlar.length > 0 ? (
                                ...
                                >
                                    <div className="flex items-center space-x-3 flex-1 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-slate-500 truncate">{t.subject || 'Konu belirtilmemiş'}</p>
                                        </div>
                                    </div>
                            ...
                            <div className="text-center text-slate-400 py-8">Henüz tebligat bulunmuyor.</div>
                        )}
                    </div>
                </Card>
                ...
                {/* Top Clients */}
                <Card>
                    <h2 className="text-xl font-bold text-white mb-4">En Çok Tebligat Alan Mükellefler</h2>
                    <div className="space-y-3">
                        {topClients.length > 0 ? (
                            topClients.map((client, index) => (
                                ...
                                >
                                    ...
                                    <span className="text-sky-400 font-bold">{client.count} tebligat</span>
                                </div>
                            ))
                        ) : (
                            <div className="text-center text-slate-400 py-8">Henüz veri bulunmuyor.</div>
                        )}
                    </div>
                </Card>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 pt-2">
                                <div className="bg-slate-800/50 rounded-lg p-3">
                                    ...
                                    <p className="text-xl font-bold text-blue-400">{credits.monthlyRemaining}</p>
                                </div>
                                <div className="bg-slate-800/50 rounded-lg p-3">
                                    <p className="text-xs text-slate-400">Satın Alınan</p>
                                    <p className="text-xl font-bold text-green-400">{credits.purchasedRemaining}</p>
                                </div>
                            </div>
